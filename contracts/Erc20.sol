...
// Emevine with Governance.
contract Emevine is BEP20('Emevine', 'VINE') {
    ...
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (Vintner).
    ...
    */
        ...
        external
    {
        ...
        require(now <= expiry, "VINE::delegateBySig: signature expired");
